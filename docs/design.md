...
5. **Interactive 2D/3D Globe Tracker & satellite detail map**:
   ...
   - Optional **Markets** checkbox pins major world indexes. Pin color is the 1-day CNBC change (green/red). Tooltip shows the index level and 1d %.
   ...
   - Optional **News** checkbox pins GDACS disaster alerts and Wikipedia featured stories at published coordinates. Hover shows a short title; click opens the report or article (`target="_blank"`).
   ...
   - A map credit strip plus popup footnotes attribute Esri, NASA EONET, USGS, Open-Meteo, CNBC, Frankfurter, The Economist Big Mac Index, OpenSky, adsbdb, GDACS, Wikipedia, and Fintraffic Digitraffic. Overlay data is free/public only.
